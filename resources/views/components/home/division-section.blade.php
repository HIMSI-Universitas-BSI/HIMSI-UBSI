<section class="bg-white py-6">
    ...
    <div class="flex flex-wrap items-center lg:px-4 py-4 lg:py-12">
        <div class="xl:w-7/12 lg:w-7/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mt-[50px]">
            <figure class="m-0 p-0"><img class="max-w-full h-auto" src="./assets/img/illustrations/i31.png" srcset="./assets/img/illustrations/i31@2x.png 2x" alt="image"></figure>
            </div>
            <!-- /column -->
            <div class="xl:w-4/12 lg:w-4/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !ml-auto !mt-[50px]">
            <div class="svg-bg bg-[#fbe7f3] rounded !mb-5"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 218.67" data-inject-url="https://sandbox-tailwind-template.netlify.app/assets/img/icons/solid/bullhorn.svg" class="svg-inject icon-svg solid text-[#e668b3] text-fuchsia"><path class="fill-secondary" d="M88 208a48.06 48.06 0 01-48-48 45.85 45.85 0 012.26-14.48 10.66 10.66 0 1120.22 6.75 24.28 24.28 0 00-1.15 7.73 26.65 26.65 0 0052.56 6.22 10.67 10.67 0 0120.77 4.87A47.71 47.71 0 0188 208z"></path><path class="fill-primary" d="M248 210.67a8 8 0 01-2.22-.32L5.78 141A8 8 0 010 133.34v-48a8 8 0 015.78-7.68l240-69.32A8 8 0 01256 16v186.7a8 8 0 01-3.2 6.4 8.09 8.09 0 01-4.8 1.57z"></path><path class="fill-primary" d="M245.33 218.67A10.67 10.67 0 01234.66 208V10.67a10.67 10.67 0 1121.34 0V208a10.66 10.66 0 01-10.67 10.67zm-234.66-64A10.66 10.66 0 010 144V74.69a10.67 10.67 0 0121.34 0V144a10.67 10.67 0 01-10.67 10.67z"></path></svg> </div>
            <h3 class="h1 !leading-[1.3] post-title !tracking-[-0.03em] !mb-3">Content Marketing Services</h3>
            <p>Maecenas faucibus mollis interdum sed posuere consectetur est at lobortis. Scelerisque id ligula porta felis euismod semper. Fusce dapibus tellus.</p>
    ...
    <!-- /.row -->
    <div class="flex flex-wrap items-center lg:px-4">
        <div class="xl:w-7/12 lg:w-7/12 w-full flex-[0_0_auto] !px-[15px] max-w-full xl:!order-2 lg:!order-2 !mt-[50px]">
        <figure class="m-0 p-0"><img class="max-w-full h-auto" src="./assets/img/illustrations/i30.png" srcset="./assets/img/illustrations/i30@2x.png 2x" alt="image"></figure>
        </div>
        <!-- /column -->
